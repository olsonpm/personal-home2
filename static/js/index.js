...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(/*! domtastic */ 1),
	    smoothscroll = __webpack_require__(/*! smoothscroll */ 21),
	    velocity = __webpack_require__(/*! velocity-animate */ 22);
	...
	function handleIsAnimating(btn) {
	  ...
	  setTimeout(function () {
	    return isAnimating.delete(btn);
	  }, DELAY);
	}
	
	function rotateButton(btn) {
	  var rotateTo = btn.hasClass('expanded') ? 0 : '180deg';
	
	  velocity(btn.find('svg')[0], { rotateZ: rotateTo }, DELAY);
	}
	
	function toggleContentState(btn) {
	  var content = btn.siblings('.content')[0];
	  var heightTo = 0;
	  ...
	  velocity(content, { height: heightTo }, DELAY, function () {
	    return btn.toggleClass('expanded');
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseClass = __webpack_require__(/*! ./baseClass */ 5);
	
	var _baseClass2 = _interopRequireDefault(_baseClass);
	
	var _domAttr = __webpack_require__(/*! ./dom/attr */ 6);
	
	var attr = _interopRequireWildcard(_domAttr);
	
	var _domClass = __webpack_require__(/*! ./dom/class */ 7);
	
	var class_ = _interopRequireWildcard(_domClass);
	
	var _domContains = __webpack_require__(/*! ./dom/contains */ 8);
	
	var contains = _interopRequireWildcard(_domContains);
	
	var _css = __webpack_require__(/*! ./css */ 9);
	
	var css = _interopRequireWildcard(_css);
	
	var _domData = __webpack_require__(/*! ./dom/data */ 10);
	
	var data = _interopRequireWildcard(_domData);
	
	var _domIndex = __webpack_require__(/*! ./dom/index */ 11);
	
	var dom = _interopRequireWildcard(_domIndex);
	
	var _domExtra = __webpack_require__(/*! ./dom/extra */ 12);
	
	var dom_extra = _interopRequireWildcard(_domExtra);
	
	var _eventIndex = __webpack_require__(/*! ./event/index */ 13);
	
	var event = _interopRequireWildcard(_eventIndex);
	
	var _domHtml = __webpack_require__(/*! ./dom/html */ 15);
	
	var html = _interopRequireWildcard(_domHtml);
	
	var _noconflict = __webpack_require__(/*! ./noconflict */ 16);
	
	var noconflict = _interopRequireWildcard(_noconflict);
	
	var _eventReady = __webpack_require__(/*! ./event/ready */ 17);
	
	var ready = _interopRequireWildcard(_eventReady);
	
	var _selectorIndex = __webpack_require__(/*! ./selector/index */ 4);
	
	var selector = _interopRequireWildcard(_selectorIndex);
	
	var _selectorClosest = __webpack_require__(/*! ./selector/closest */ 14);
	
	var closest = _interopRequireWildcard(_selectorClosest);
	
	var _selectorExtra = __webpack_require__(/*! ./selector/extra */ 18);
	
	var selector_extra = _interopRequireWildcard(_selectorExtra);
	
	var _eventTrigger = __webpack_require__(/*! ./event/trigger */ 19);
	
	var trigger = _interopRequireWildcard(_eventTrigger);
	
	var _type = __webpack_require__(/*! ./type */ 20);
...
/* 4 */
/*!************************************************!*\
  !*** ./~/domtastic/commonjs/selector/index.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 5 */
/*!*******************************************!*\
  !*** ./~/domtastic/commonjs/baseClass.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 6 */
/*!******************************************!*\
  !*** ./~/domtastic/commonjs/dom/attr.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 7 */
/*!*******************************************!*\
  !*** ./~/domtastic/commonjs/dom/class.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 8 */
/*!**********************************************!*\
  !*** ./~/domtastic/commonjs/dom/contains.js ***!
  \**********************************************/
/***/ function(module, exports) {
...
/* 10 */
/*!******************************************!*\
  !*** ./~/domtastic/commonjs/dom/data.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 11 */
/*!*******************************************!*\
  !*** ./~/domtastic/commonjs/dom/index.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 12 */
/*!*******************************************!*\
  !*** ./~/domtastic/commonjs/dom/extra.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _index = __webpack_require__(/*! ./index */ 11);
...
/* 13 */
/*!*********************************************!*\
  !*** ./~/domtastic/commonjs/event/index.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 14 */
/*!**************************************************!*\
  !*** ./~/domtastic/commonjs/selector/closest.js ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 15 */
/*!******************************************!*\
  !*** ./~/domtastic/commonjs/dom/html.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 16 */
/*!********************************************!*\
  !*** ./~/domtastic/commonjs/noconflict.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 17 */
/*!*********************************************!*\
  !*** ./~/domtastic/commonjs/event/ready.js ***!
  \*********************************************/
/***/ function(module, exports) {
...
/* 18 */
/*!************************************************!*\
  !*** ./~/domtastic/commonjs/selector/extra.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 19 */
/*!***********************************************!*\
  !*** ./~/domtastic/commonjs/event/trigger.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
